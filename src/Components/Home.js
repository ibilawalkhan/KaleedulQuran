            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity style={styles.btnView} onPress={() => navigation.navigate('Verses')}>
                    <View style={styles.fullBtn}>
                        ...
                        <View><Image source={require('../Images/book.jpeg')} style={styles.icon} /></View>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.btnView} onPress={() => navigation.navigate('Feeling')}>
                    <View style={styles.fullBtn}>
                        ...
                        <View><Image source={require('../Images/feeling.jpeg')} style={styles.icon} /></View>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.btnView} onPress={() => navigation.navigate('Stories')}>
                    <View style={styles.fullBtn}>
                        ...
                        <View><Image source={require('../Images/stories.jpeg')} style={styles.icon} /></View>
                    </View>
                </TouchableOpacity>
            </View>
            <View>
